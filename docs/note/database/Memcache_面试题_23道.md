---
title: Memcache 面试题  23道
source: Note/Memcache 面试题  23道.pdf
pages: 9
...
1__
如果碰到
商秒杀等高并发的业务，一定要事先预热，或者其它思想实现，例如：称杀只是获取
资格，而
是瞬间秒杀到手商品。
那么什么是获取资格？
...
![Memcache 面试题  23道 第1页插图](../assets/images/Memcache_面试题_23道_p1_1_0b055075.png)
