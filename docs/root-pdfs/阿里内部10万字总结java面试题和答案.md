---
title: 阿里内部10万字总结java面试题和答案
source: 阿里内部10万字总结java面试题和答案.pdf
pages: 266
converted_at: 2026-06-22 22:28:33
---

# 阿里内部10万字总结java面试题和答案

面试题
 
阿里内部资料

![阿里内部10万字总结java面试题和答案 第1页插图](../assets/images/阿里内部10万字总结java面试题和答案_p1_1_66a70aa4.png)
...
10、String、String StringBuﬀer 和 StringBuilder 的区别是什
么?
...
String是只读字符串，它并不是基本数据类型，而是一个对象。从底层源码来看是一个ﬁnal类型的
字符数组，所引用的字符串不能被改变，一经定义，无法再增删改。每次对String的操作都会生成
新的String对象。
每次+操作 ： 隐式在堆上new了一个跟原字符串相同的StringBuilder对象，再调用append方法 拼
接+后面的字符。
StringBuﬀer和StringBuilder他们两都继承了AbstractStringBuilder抽象类，从
AbstractStringBuilder抽象类中我们可以看到
他们的底层都是可变的字符数组，所以在进行频繁的字符串操作时，建议使用StringBuﬀer和
StringBuilder来进行操作。 另外StringBuﬀer 对方法加了同步锁或者对调用的方法加了同步锁，所
...
在构造函数内对一个ﬁnal域的写入,与随后把这个被构造对象的引用赋值给一个引用变量,这两个操作
之间不能重排序 初次读一个包含ﬁnal域的对象的引用,与随后初次读这个ﬁnal域,这两个操作之间不
能重排序.
20、static都有哪些用法?
...
3、ﬁnally是在return后面的表达式运算后执行的（此时并没有返回运算后的值，而是先把要返回的
值保存起来，管ﬁnally中的代码怎么样，返回的值都不会改变，任然是之前保存的值），所以函数
返回值是在ﬁnally执行前确定的；
...
生的ConcurrentModiﬁcationException异常（java.util包下面的所有的集合类都是快速失败
...
ConcurrentModiﬁcationException 异常，从而产生fail-fast机制，这个错叫并发修改异常。Fail-
safe，java.util.concurrent包下面的所有的类都是安全失败的，在遍历过程中，如果已经遍历的数
组上的内容变化了，迭代器不会抛出ConcurrentModiﬁcationException异常。如果未遍历的数组
...
![阿里内部10万字总结java面试题和答案 第20页插图](../assets/images/阿里内部10万字总结java面试题和答案_p20_1_08a43f00.jpeg)
...
![阿里内部10万字总结java面试题和答案 第21页插图](../assets/images/阿里内部10万字总结java面试题和答案_p21_1_2539ba1f.jpeg)
...
ReﬂectASM工具类，通过字节码生成的方式加快反射速度 2）相对不安全，破坏了封装性（因为通
过反射可以获得私有方法和属性）
...
![阿里内部10万字总结java面试题和答案 第23页插图](../assets/images/阿里内部10万字总结java面试题和答案_p23_1_43085b39.png)
...
了，那么线程 A 访问集合时，就会抛出 ConcurrentModiﬁcationException 异常，产生 fail-fast 事
...
ConcurrentModiﬁcationException 异常。
...
![阿里内部10万字总结java面试题和答案 第29页插图](../assets/images/阿里内部10万字总结java面试题和答案_p29_1_09d0c18b.png)
...
![阿里内部10万字总结java面试题和答案 第30页插图](../assets/images/阿里内部10万字总结java面试题和答案_p30_1_1fba8b59.png)
...
![阿里内部10万字总结java面试题和答案 第31页插图](../assets/images/阿里内部10万字总结java面试题和答案_p31_1_b4e7ae0d.png)
...
![阿里内部10万字总结java面试题和答案 第32页插图](../assets/images/阿里内部10万字总结java面试题和答案_p32_1_78ebb52f.png)
...
准备进行内存分配,为static修饰的类变量分配内存,并设置初始值(0或null).不包含ﬁnal修饰的静态变
量,因为ﬁnal变量在编译时分配.
...
![阿里内部10万字总结java面试题和答案 第33页插图](../assets/images/阿里内部10万字总结java面试题和答案_p33_1_5ea6be88.png)

![阿里内部10万字总结java面试题和答案 第33页插图](../assets/images/阿里内部10万字总结java面试题和答案_p33_2_085fccfb.png)
...
![阿里内部10万字总结java面试题和答案 第34页插图](../assets/images/阿里内部10万字总结java面试题和答案_p34_1_f536b239.png)

![阿里内部10万字总结java面试题和答案 第34页插图](../assets/images/阿里内部10万字总结java面试题和答案_p34_2_78026b39.png)
...
![阿里内部10万字总结java面试题和答案 第35页插图](../assets/images/阿里内部10万字总结java面试题和答案_p35_1_642d0b16.png)
...
![阿里内部10万字总结java面试题和答案 第36页插图](../assets/images/阿里内部10万字总结java面试题和答案_p36_1_a6b26846.png)
...
抛出stackOverﬂowError；如果栈是可动态扩展的，但没有内存空间支持扩展，则抛出
OutofMemoryError。 使用jclasslib工具可以查看class类文件的结构。下图为栈帧结构图：
阿里内部资料

![阿里内部10万字总结java面试题和答案 第37页插图](../assets/images/阿里内部10万字总结java面试题和答案_p37_1_232dc3ce.png)
...
![阿里内部10万字总结java面试题和答案 第38页插图](../assets/images/阿里内部10万字总结java面试题和答案_p38_1_0c24a7b5.png)

![阿里内部10万字总结java面试题和答案 第38页插图](../assets/images/阿里内部10万字总结java面试题和答案_p38_2_b67f90a6.png)
...
![阿里内部10万字总结java面试题和答案 第41页插图](../assets/images/阿里内部10万字总结java面试题和答案_p41_1_3f724efe.png)
...
![阿里内部10万字总结java面试题和答案 第43页插图](../assets/images/阿里内部10万字总结java面试题和答案_p43_1_c71c9ffd.png)
...
![阿里内部10万字总结java面试题和答案 第47页插图](../assets/images/阿里内部10万字总结java面试题和答案_p47_1_af694c5b.png)
...
![阿里内部10万字总结java面试题和答案 第48页插图](../assets/images/阿里内部10万字总结java面试题和答案_p48_1_70991cbc.png)
...
![阿里内部10万字总结java面试题和答案 第49页插图](../assets/images/阿里内部10万字总结java面试题和答案_p49_1_b963cd98.png)
...
![阿里内部10万字总结java面试题和答案 第50页插图](../assets/images/阿里内部10万字总结java面试题和答案_p50_1_6b4bcec2.png)
...
内存,这就是TLAB（Thread Local Allocation Buﬀer，本地线程分配缓存） 。虚拟机通过-
XX:UseTLAB 设定它的。
28、对象头具体都包含哪些内容？
...
![阿里内部10万字总结java面试题和答案 第51页插图](../assets/images/阿里内部10万字总结java面试题和答案_p51_1_0dc53521.png)
...
![阿里内部10万字总结java面试题和答案 第52页插图](../assets/images/阿里内部10万字总结java面试题和答案_p52_1_6573a0fc.png)
...
![阿里内部10万字总结java面试题和答案 第53页插图](../assets/images/阿里内部10万字总结java面试题和答案_p53_1_b013b939.png)
...
存多重映射等技术来实现可并发的标记-整理算法的收集器。在JDK 11 新加入，还在实验阶
...
败，那么选择G1 、ZGC 、CMS 都是合理的。虽然这些收集器的 GC 停顿通常都比较短，但它
...
![阿里内部10万字总结java面试题和答案 第55页插图](../assets/images/阿里内部10万字总结java面试题和答案_p55_1_0ef2f08b.png)

---

当 tomcat启动时，会创建几种类加载器： Bootstrap 引导类加载器 加载 JVM启动所需的类，以及
标准扩展类（位于jre/lib/ext  下） System 系统类加载器 加载 tomcat 启动的类，比如
bootstrap.jar，通常在 catalina.bat 或者 catalina.sh 中指定。位于CATALINA_HOME/bin 下。
Common 通用类加载器
 
 
欢迎关注微信公众号：Java后端技术全栈
...
![阿里内部10万字总结java面试题和答案 第56页插图](../assets/images/阿里内部10万字总结java面试题和答案_p56_1_dea809d1.png)
...
x = 4;         //语句4 
y = -1;       //语句5 
由于ﬂag变量为volatile变量，那么在进行指令重排序的过程的时候，不会将语句3放到语句1、语句
...
数据修改，也不会抛出ConcurrentModiﬁcationException。
13、什么是线程安全
...
（1）不可变
像String、Integer、Long这些，都是ﬁnal类型的类，任何一个线程都改变不了它们的值，要改变除
...
Vector，99%的情况下都会出现ConcurrentModiﬁcationException，也就是fail-fast机制。
（4）线程非安全
...
![阿里内部10万字总结java面试题和答案 第66页插图](../assets/images/阿里内部10万字总结java面试题和答案_p66_1_3f2f3344.png)
...
![阿里内部10万字总结java面试题和答案 第67页插图](../assets/images/阿里内部10万字总结java面试题和答案_p67_1_aec3f348.png)
...
![阿里内部10万字总结java面试题和答案 第71页插图](../assets/images/阿里内部10万字总结java面试题和答案_p71_1_40c40e21.png)

![阿里内部10万字总结java面试题和答案 第71页插图](../assets/images/阿里内部10万字总结java面试题和答案_p71_2_6481c9f0.png)
...
![阿里内部10万字总结java面试题和答案 第72页插图](../assets/images/阿里内部10万字总结java面试题和答案_p72_1_64075f40.png)
...
![阿里内部10万字总结java面试题和答案 第81页插图](../assets/images/阿里内部10万字总结java面试题和答案_p81_1_a283c2b2.png)
...
![阿里内部10万字总结java面试题和答案 第82页插图](../assets/images/阿里内部10万字总结java面试题和答案_p82_1_58302340.jpeg)
...
![阿里内部10万字总结java面试题和答案 第85页插图](../assets/images/阿里内部10万字总结java面试题和答案_p85_1_6209c9e0.png)
...
器，当容器启动结束后，通过获取BeanDeﬁnition对象中的信息，实例化所有的bean。
阿里内部资料

---

（2）设置对象属性（依赖注入）：
实例化后的对象被封装在BeanWrapper对象中，紧接着，Spring根据BeanDeﬁnition中的信息 以
...
![阿里内部10万字总结java面试题和答案 第88页插图](../assets/images/阿里内部10万字总结java面试题和答案_p88_1_bf1c2c76.png)
...
![阿里内部10万字总结java面试题和答案 第90页插图](../assets/images/阿里内部10万字总结java面试题和答案_p90_1_fb6a6be0.png)
...
![阿里内部10万字总结java面试题和答案 第92页插图](../assets/images/阿里内部10万字总结java面试题和答案_p92_1_059e2cd9.png)
...
![阿里内部10万字总结java面试题和答案 第93页插图](../assets/images/阿里内部10万字总结java面试题和答案_p93_1_396e69e9.png)
...
![阿里内部10万字总结java面试题和答案 第98页插图](../assets/images/阿里内部10万字总结java面试题和答案_p98_1_b8a32b3d.png)
...
![阿里内部10万字总结java面试题和答案 第99页插图](../assets/images/阿里内部10万字总结java面试题和答案_p99_1_988dd9ab.png)
...
![阿里内部10万字总结java面试题和答案 第100页插图](../assets/images/阿里内部10万字总结java面试题和答案_p100_1_8e34508f.png)
...
![阿里内部10万字总结java面试题和答案 第101页插图](../assets/images/阿里内部10万字总结java面试题和答案_p101_1_5388890f.png)
...
@EnableAutoConﬁguration：打开自动配置的功能，也可以关闭某个自动配置的选项，如关闭数
据源自动配置功能： @SpringBootApplication(exclude = { DataSourceAutoConﬁguration.class
})。
...
![阿里内部10万字总结java面试题和答案 第103页插图](../assets/images/阿里内部10万字总结java面试题和答案_p103_1_97f93333.png)

![阿里内部10万字总结java面试题和答案 第103页插图](../assets/images/阿里内部10万字总结java面试题和答案_p103_2_5fb0f90f.png)

![阿里内部10万字总结java面试题和答案 第103页插图](../assets/images/阿里内部10万字总结java面试题和答案_p103_3_cc317c1d.png)
...
使用 Spring Cloud Conﬁg 配置中心时，这时需要在 bootstrap 配置文件中添加连接到配置中
...
![阿里内部10万字总结java面试题和答案 第106页插图](../assets/images/阿里内部10万字总结java面试题和答案_p106_1_5351fdba.png)

![阿里内部10万字总结java面试题和答案 第106页插图](../assets/images/阿里内部10万字总结java面试题和答案_p106_2_6191c00f.png)
...
样，但后者在排序时会消耗更多内存，因为 ORDER BY col 采用 ﬁxed_length 计算 col 长度
（memory 引擎也一样）。
...
![阿里内部10万字总结java面试题和答案 第112页插图](../assets/images/阿里内部10万字总结java面试题和答案_p112_1_785be42c.png)
...
![阿里内部10万字总结java面试题和答案 第116页插图](../assets/images/阿里内部10万字总结java面试题和答案_p116_1_3bc5f23f.png)
...
![阿里内部10万字总结java面试题和答案 第120页插图](../assets/images/阿里内部10万字总结java面试题和答案_p120_1_0c10019f.png)

![阿里内部10万字总结java面试题和答案 第120页插图](../assets/images/阿里内部10万字总结java面试题和答案_p120_2_3ae963fc.png)

---

如果ﬁrstPage method() 中的异常继续发生，则Hystrix电路将中断，并且员工使用者将一起跳过
ﬁrtsPage方法，并直接调用回退方法。 断路器的目的是给第一页方法或第一页方法可能调用的其他
...
![阿里内部10万字总结java面试题和答案 第121页插图](../assets/images/阿里内部10万字总结java面试题和答案_p121_1_8dc6d2ad.png)

![阿里内部10万字总结java面试题和答案 第121页插图](../assets/images/阿里内部10万字总结java面试题和答案_p121_2_ee02f07e.png)
...
第二层：conﬁg 层，配置层，主要是对 Dubbo 进行各种配置的，Dubbo 相关配置；
第三层：proxy 层，服务代理层，透明生成客户端的 stub 和服务单的 skeleton，调用的是接
口，实现类没有，所以得生成代理，代理之间再进行网络通讯、负责均衡等；
第四层：registry 层，服务注册层，负责服务的注册与发现；
阿里内部资料

![阿里内部10万字总结java面试题和答案 第123页插图](../assets/images/阿里内部10万字总结java面试题和答案_p123_1_001e06c5.png)

![阿里内部10万字总结java面试题和答案 第123页插图](../assets/images/阿里内部10万字总结java面试题和答案_p123_2_994e8652.png)
...
![阿里内部10万字总结java面试题和答案 第124页插图](../assets/images/阿里内部10万字总结java面试题和答案_p124_1_5a0e991d.png)
...
![阿里内部10万字总结java面试题和答案 第125页插图](../assets/images/阿里内部10万字总结java面试题和答案_p125_1_cfcba96b.png)
...
![阿里内部10万字总结java面试题和答案 第126页插图](../assets/images/阿里内部10万字总结java面试题和答案_p126_1_5edf0b9c.png)
...
Spring Cloud 使用的是 Spring Cloud Netﬂix Eureka。
监控
Dubbo 使用的是 Dubbo-monitor；Spring Cloud 使用的是 Spring Boot admin。
断路器
Dubbo 在断路器这方面还不完善，Spring Cloud 使用的是 Spring Cloud Netﬂix Hystrix。
...
![阿里内部10万字总结java面试题和答案 第129页插图](../assets/images/阿里内部10万字总结java面试题和答案_p129_1_851e8012.jpeg)
...
![阿里内部10万字总结java面试题和答案 第132页插图](../assets/images/阿里内部10万字总结java面试题和答案_p132_1_413c5874.jpeg)
...
果你要确保说写 RabbitMQ 的消息别丢，可以开启conﬁrm模式，在生产者那里设置开启conﬁrm模
...
conﬁrm机制是异步的，你发送个消息之后就可以发送下一个消息，然后那个消息RabbitMQ 接收
...
盘上重启恢复 queue，恢复这个 queue 里的数据。持久化可以跟生产者那边的conﬁrm机制配合起
...
![阿里内部10万字总结java面试题和答案 第137页插图](../assets/images/阿里内部10万字总结java面试题和答案_p137_1_9248a72a.png)
...
![阿里内部10万字总结java面试题和答案 第138页插图](../assets/images/阿里内部10万字总结java面试题和答案_p138_1_8e5b1664.png)

![阿里内部10万字总结java面试题和答案 第138页插图](../assets/images/阿里内部10万字总结java面试题和答案_p138_2_c93d047a.png)
...
![阿里内部10万字总结java面试题和答案 第145页插图](../assets/images/阿里内部10万字总结java面试题和答案_p145_1_a0fd92dc.png)
...
![阿里内部10万字总结java面试题和答案 第146页插图](../assets/images/阿里内部10万字总结java面试题和答案_p146_1_0aaf2da3.png)

![阿里内部10万字总结java面试题和答案 第146页插图](../assets/images/阿里内部10万字总结java面试题和答案_p146_2_a421e067.png)
...
![阿里内部10万字总结java面试题和答案 第147页插图](../assets/images/阿里内部10万字总结java面试题和答案_p147_1_7c9374b3.png)
...
Zookeeper 允许客户端向服务端的某个znode 注册一个 Watcher 监听，当服务端的一些指定事件
...
客户端回调 Watcher
1，客户端 SendThread 线程接收事件通知，交由EventThread 线程回调Watcher 。 2，客户端
...
在一个集群中，最少需要 3 台。或者保证2N + 1 台，即奇数。为什么保证奇数？主要是为了选举
算法。
 
...
![阿里内部10万字总结java面试题和答案 第150页插图](../assets/images/阿里内部10万字总结java面试题和答案_p150_1_096681e8.png)

---

8，Zookeeper 集群中是怎样选举leader的？
 
当Leader崩溃了，或者失去了大多数的Follower，这时候Zookeeper 就进入恢复模式，恢复模式需
要重新选举出一个新的Leader，让所有的Server都恢复到一个状态LOOKING 。
Zookeeper 有两种选举算法：基于basic paxos 实现和基于fast paxos 实现。默认为fast paxos
由于篇幅问题，这里推荐：选举流程
 
...
高 32 位是 epoch 用来标识Leader 是否发生了改变，如果有新的 Leader 产生出来，epoch 会自
...
![阿里内部10万字总结java面试题和答案 第152页插图](../assets/images/阿里内部10万字总结java面试题和答案_p152_1_aea0a55a.png)
...
![阿里内部10万字总结java面试题和答案 第154页插图](../assets/images/阿里内部10万字总结java面试题和答案_p154_1_7e4fd2d0.png)
...
![阿里内部10万字总结java面试题和答案 第155页插图](../assets/images/阿里内部10万字总结java面试题和答案_p155_1_a31d3731.png)
...
![阿里内部10万字总结java面试题和答案 第158页插图](../assets/images/阿里内部10万字总结java面试题和答案_p158_1_1d8d9bd0.png)
...
![阿里内部10万字总结java面试题和答案 第161页插图](../assets/images/阿里内部10万字总结java面试题和答案_p161_1_262c5fa6.png)
...
![阿里内部10万字总结java面试题和答案 第163页插图](../assets/images/阿里内部10万字总结java面试题和答案_p163_1_5c2acb40.png)
...
且通知其他的follower，其他ﬂower在之后作出相关反应，这样就完成了一个切换，这种模式也是
...
能，带来更高的并发量。Redis 的读写性能比Mysql 好的多，我们就可以把Mysql 中的热点数据缓
存到Redis 中，提升读取性能，同时也减轻了Mysql 的读取压力。
欢迎关注微信公众号：Java后端技术全栈
2，使用 Redis 有哪些好处？
...
Redis 和Memcache 都是将数据存放在内存中，都是内存数据库。不过Memcache 还可用于缓存
其他东西，例如图片、视频等等。 
...
分布式–设定Memcache 集群，利用magent 做一主多从; Redis 可以做一主多从。都可以一主一
从 
...
Memcached 网络IO模型是多线程，非阻塞IO复用的网络模型，原型上接近于nignx 。而Redis
使用单线程的IO复用模型，自己封装了一个简单的AeEvent 事件处理框架，主要实现类
epoll，kqueue 和select ，更接近于Apache早期的模式。
 
...
这问题是因为前面回答问题的时候提到了Redis 是基于非阻塞的IO复用模型。如果这个问题回
...
内存中完成 set key value 的设置。操作完成后，它会将 Socket01 的AE_WRITABLE  事件与令
回复处理器关联。
3. 如果此时客户端准备好接收返回结果了，那么  Redis  中的 Socket01 会产生一个 
AE_WRITABLE 事件，同样压入队列中，事件分派器找到相关联的命令回复处理器，由命令回复
阿里内部资料

![阿里内部10万字总结java面试题和答案 第168页插图](../assets/images/阿里内部10万字总结java面试题和答案_p168_1_7fc72ae2.png)
...
优点
速度快：因为数据存在内存中，类似于HashMap  ，HashMap 的优势就是查找和操作的时间复杂
度都是O (1) 。
...
![阿里内部10万字总结java面试题和答案 第170页插图](../assets/images/阿里内部10万字总结java面试题和答案_p170_1_26338464.png)

---

是指所有的命令行记录以Redis  命令请求协议的格式完全持久化存储，保存为 AOF 文件。
优点：
（1）数据安全，AOF 持久化可以配置appendfsync  属性，有 always，每进行一次命令操作就记录
到 AOF 文件中一次。
...
一般使用 list 结构作为队列，rpush 生产消息，lpop  消费消息。当lpop 没有消息的时候，要适当
sleep 一会再重试。
...
zrangebyscore 指令获取N 秒之前的数据轮询进行处理。
...
存。
3. Twemprox
Twemprox 是Twtter 开源的一个 Redis 和 Memcached  代理服务器，主要用于管理 Redis 和
Memcached  集群，减少与Cache 服务器直接连接的数量。
4. Codis
Codis 是一个代理中间件，当客户端向Codis 发送指令时，Codis 负责将指令转发到后面的
Redis 来执行，并将结果返回给客户端。一个Codis 实例可以连接多个Redis 实例，也可以启
动多个Codis 实例来支撑，每个Codis 节点都是对等的，这样可以增加整体的QPS 需求，还能
起到容灾功能。
5. 客户端分片
在Redis Cluster 还没出现之前使用较多，现在基本很少热你使用了，在业务代码层实现，起
几个毫无关联的Redis 实例，在代码层，对 Key 进行 hash 计算，然后去对应的 Redis 实例操
...
在数据提交前要向后端服务的申请token，token放到Redis 或JVM 内存，token有效时间。提交后
...
虑id是否为主键，如果id不是主键或者不是InnoDB 存储引擎，那么就会出现锁全表）。
5，乐观锁，给数据库表增加一个version字段，可以通过这个字段来判断是否已经被修改了
6，分布式锁，比如Redis 、Zookeeper 的分布式锁。单号为key，然后给Key设置有效期（防止支
...
![阿里内部10万字总结java面试题和答案 第184页插图](../assets/images/阿里内部10万字总结java面试题和答案_p184_1_8596c351.png)
...
![阿里内部10万字总结java面试题和答案 第186页插图](../assets/images/阿里内部10万字总结java面试题和答案_p186_1_bbe3cd52.png)
...
![阿里内部10万字总结java面试题和答案 第187页插图](../assets/images/阿里内部10万字总结java面试题和答案_p187_1_bf91c964.png)
...
Conﬁrm 阶段主要是对业务系统做确认提交，Try阶段执行成功并开始执行 Conﬁrm阶段时，默
认 Conﬁrm阶段是不会出错的。即：只要Try成功，Conﬁrm一定成功。
Cancel 阶段主要是在业务执行错误，需要回滚的状态下执行的业务取消，预留资源释放。
举个例子，假入你要向 老田 转账，思路大概是： 我们有一个本地方法，里面依次调用步骤： 1、
首先在 Try 阶段，要先调用远程接口把 你 和 老田 的钱给冻结起来。 2、在 Conﬁrm 阶段，执行远
程调用的转账的操作，转账成功进行解冻。 3、如果第2步执行成功，那么转账成功，如果第二步执
行失败，则调用远程冻结接口对应的解冻方法 (Cancel)。
优点：
性能提升：具体业务来实现控制资源锁的粒度变小，不会锁定整个资源。
数据最终一致性：基于 Conﬁrm 和 Cancel 的幂等性，保证事务最终完成确认或者取消，保证数据
的一致性。
可靠性：解决了 XA 协议的协调者单点故障问题，由主业务方发起并控制整个业务活动，业务活动
管理器也变成多点，引入集群。
缺点：TCC 的 Try、Conﬁrm 和 Cancel 操作功能要按具体业务来实现，业务耦合度较高，提高了开
发成本。
阿里内部资料

![阿里内部10万字总结java面试题和答案 第189页插图](../assets/images/阿里内部10万字总结java面试题和答案_p189_1_48a6a97e.png)
...
![阿里内部10万字总结java面试题和答案 第190页插图](../assets/images/阿里内部10万字总结java面试题和答案_p190_1_b504210e.png)
...
![阿里内部10万字总结java面试题和答案 第191页插图](../assets/images/阿里内部10万字总结java面试题和答案_p191_1_8df3df49.png)
...
![阿里内部10万字总结java面试题和答案 第192页插图](../assets/images/阿里内部10万字总结java面试题和答案_p192_1_04156610.png)
...
![阿里内部10万字总结java面试题和答案 第193页插图](../assets/images/阿里内部10万字总结java面试题和答案_p193_1_ccf54f05.png)
...
![阿里内部10万字总结java面试题和答案 第194页插图](../assets/images/阿里内部10万字总结java面试题和答案_p194_1_05f276fd.png)
...
![阿里内部10万字总结java面试题和答案 第195页插图](../assets/images/阿里内部10万字总结java面试题和答案_p195_1_be9e2f4b.png)
...
6. 百度UidGenerator
UidGenerator是百度开源的分布式ID生成器，基于于snowﬂake算法的实现，看起来感觉还行。不
过，国内开源的项目维护性真是担忧。
7. 美团Leaf
...
![阿里内部10万字总结java面试题和答案 第197页插图](../assets/images/阿里内部10万字总结java面试题和答案_p197_1_12f33fff.png)
...
![阿里内部10万字总结java面试题和答案 第198页插图](../assets/images/阿里内部10万字总结java面试题和答案_p198_1_3f972bf2.png)

![阿里内部10万字总结java面试题和答案 第198页插图](../assets/images/阿里内部10万字总结java面试题和答案_p198_2_6c54a749.png)
...
![阿里内部10万字总结java面试题和答案 第199页插图](../assets/images/阿里内部10万字总结java面试题和答案_p199_1_579fc1f1.png)
...
![阿里内部10万字总结java面试题和答案 第200页插图](../assets/images/阿里内部10万字总结java面试题和答案_p200_1_6e0642ce.png)
...
![阿里内部10万字总结java面试题和答案 第201页插图](../assets/images/阿里内部10万字总结java面试题和答案_p201_1_e714ca43.png)
...
端口不同：HTTP和HTTPS 的连接方式不同没用的端口也不一样，HTTP是80，HTTPS 用的是443
...
![阿里内部10万字总结java面试题和答案 第205页插图](../assets/images/阿里内部10万字总结java面试题和答案_p205_1_938b9b51.png)
...
![阿里内部10万字总结java面试题和答案 第206页插图](../assets/images/阿里内部10万字总结java面试题和答案_p206_1_ed52b291.png)

![阿里内部10万字总结java面试题和答案 第206页插图](../assets/images/阿里内部10万字总结java面试题和答案_p206_2_f683c9b8.png)

![阿里内部10万字总结java面试题和答案 第206页插图](../assets/images/阿里内部10万字总结java面试题和答案_p206_3_13a9ac82.png)

![阿里内部10万字总结java面试题和答案 第206页插图](../assets/images/阿里内部10万字总结java面试题和答案_p206_4_bfd7c8b5.png)
...
![阿里内部10万字总结java面试题和答案 第208页插图](../assets/images/阿里内部10万字总结java面试题和答案_p208_1_16be434b.png)
...
![阿里内部10万字总结java面试题和答案 第214页插图](../assets/images/阿里内部10万字总结java面试题和答案_p214_1_93d4ff28.png)
...
![阿里内部10万字总结java面试题和答案 第215页插图](../assets/images/阿里内部10万字总结java面试题和答案_p215_1_e3fc87ec.png)
...
![阿里内部10万字总结java面试题和答案 第216页插图](../assets/images/阿里内部10万字总结java面试题和答案_p216_1_48dedfeb.png)
...
荷。
HTTP2.0使用encoder来减少需要传输的header大小，通讯双方各自cache一份header ﬁelds表，
...
会再给你发数据了(当然，在ﬁn包之前发送出去的数据，如果没有收到对应的ack确认报文，主动关
...
![阿里内部10万字总结java面试题和答案 第220页插图](../assets/images/阿里内部10万字总结java面试题和答案_p220_1_6cd6617c.png)
...
![阿里内部10万字总结java面试题和答案 第221页插图](../assets/images/阿里内部10万字总结java面试题和答案_p221_1_5b2de4fd.png)
...
![阿里内部10万字总结java面试题和答案 第224页插图](../assets/images/阿里内部10万字总结java面试题和答案_p224_1_a61d3fa8.png)
...
![阿里内部10万字总结java面试题和答案 第231页插图](../assets/images/阿里内部10万字总结java面试题和答案_p231_1_d5ad22ff.png)
...
![阿里内部10万字总结java面试题和答案 第232页插图](../assets/images/阿里内部10万字总结java面试题和答案_p232_1_e7773a35.png)
...
核对了一下代码，核心入口为 ﬁndMaster，选择主节点成功返回对应 Master，否则返回 null。选
举流程大致描述如下：
...
![阿里内部10万字总结java面试题和答案 第239页插图](../assets/images/阿里内部10万字总结java面试题和答案_p239_1_6cdcbf8a.jpeg)
...
![阿里内部10万字总结java面试题和答案 第240页插图](../assets/images/阿里内部10万字总结java面试题和答案_p240_1_5f62331c.jpeg)
...
![阿里内部10万字总结java面试题和答案 第241页插图](../assets/images/阿里内部10万字总结java面试题和答案_p241_1_59fbad68.jpeg)
...
![阿里内部10万字总结java面试题和答案 第246页插图](../assets/images/阿里内部10万字总结java面试题和答案_p246_1_c01010f5.png)
...
![阿里内部10万字总结java面试题和答案 第247页插图](../assets/images/阿里内部10万字总结java面试题和答案_p247_1_7ef72bf8.png)

![阿里内部10万字总结java面试题和答案 第247页插图](../assets/images/阿里内部10万字总结java面试题和答案_p247_2_f467d170.png)
...
![阿里内部10万字总结java面试题和答案 第248页插图](../assets/images/阿里内部10万字总结java面试题和答案_p248_1_75b03a60.png)
...
![阿里内部10万字总结java面试题和答案 第250页插图](../assets/images/阿里内部10万字总结java面试题和答案_p250_1_9aa07f46.png)
...
中可以看出，每个更改首先在暂存区域中进行验证，我将其称为“stage ﬁle”，然后将更改提交到存
储库。
9、什么是 git stash?
...
![阿里内部10万字总结java面试题和答案 第252页插图](../assets/images/阿里内部10万字总结java面试题和答案_p252_1_9d12a03c.png)
...
stash@{0}: WIP on master: 049d078 added the index ﬁle stash@{1}: WIP on master: c264051
Revert “added ﬁle_size” stash@{2}: WIP on master: 21d80a5 added number to log
...
新增文件的命令：git add ﬁle或者git add . 提交文件的命令：git commit –m或者git commit –a 查
看工作区状况：git status –s 拉取合并远程分支的操作：git fetch/git merge或者git pull 查看提交
记录命令：git reﬂog
22、如果本次提交误操作，如何撤销？
 
如果想撤销提交到索引区的文件，可以通过git reset HEAD ﬁle；如果想撤销提交到本地仓库的文
...
信息；
命令git reﬂog –number: 表示查看所有分支前number个简化的提交历史记录；
命令git reﬂog –number –pretty=oneline：显示简化的信息历史信息； 
...
虽说面试和工作是两回事，但是你要想要获得自己满意的 oﬀer ，你自身的实力必须要强。
4、必知必会的几点
...
问题不给你 Oﬀer 的。 所以在谈薪资的时候要大胆一些，让对方看到你底气。就算最后HR真的没有
