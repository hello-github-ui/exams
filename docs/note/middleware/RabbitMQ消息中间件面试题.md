---
title: RabbitMQ消息中间件面试题
source: Note/RabbitMQ消息中间件面试题.pdf
pages: 5
...
![RabbitMQ消息中间件面试题 第1页插图](../assets/images/RabbitMQ消息中间件面试题_p1_1_0b055075.png)
...
consumer 订阅 queue 的owner node，则 consumer 只能通过 Consumer Cancellation 
...
问题二十四：RabbitMQ 中的 cluster、mirrored queue，以及 warrens 机制分别用于解决
什么问题？存在哪些问题？  
...
Warrens 
模型存在的问题：对于第一种模型，虽然理论上讲不会丢失消息，但若在该模型
