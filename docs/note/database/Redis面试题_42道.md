...
![Redis面试题  42道 第1页插图](../assets/images/Redis面试题_42道_p1_1_0b055075.png)
...
收的策略。
使用策略规则：
1、如果数据呈现幂律分布，也就是一部分数据访问频率高，一部分数据访问频率   低， 则使用 allkeys-
lru
...
设置密码： conﬁg set requirepass 123456 授权密码： auth 123456
 
20、说说 Redis 哈希槽的概念？
