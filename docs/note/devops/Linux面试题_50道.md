...
![Linux面试题 50道 第1页插图](../assets/images/Linux面试题_50道_p1_1_0b055075.png)
...
![Linux面试题 50道 第3页插图](../assets/images/Linux面试题_50道_p3_1_ad9e0e58.png)
...
![Linux面试题 50道 第6页插图](../assets/images/Linux面试题_50道_p6_1_0348e7f4.png)
...
存放系统管理和配置文件；
/home
存放所有用户文件的根目录，是用户主目录的基点，比如用户user的主目
...
/sbin
存放二进制可执行文件，只有root才能访问。这里存放的是系统管理员使用
...
![Linux面试题 50道 第7页插图](../assets/images/Linux面试题_50道_p7_1_398229af.png)
