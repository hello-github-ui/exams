...
![Java异常面试题 33道 第1页插图](../assets/images/Java异常面试题_33道_p1_1_ee8e19c1.png)

![Java异常面试题 33道 第1页插图](../assets/images/Java异常面试题_33道_p1_2_0b055075.png)
...
到指定的类异常），IOException（IO流异常），要么通过throws进行声明抛出，要么通过try-
catch进行捕获处理，否则不能通过编译。在程序中，通常不会自定义该类异常，而是直接使用系
...
![Java异常面试题 33道 第3页插图](../assets/images/Java异常面试题_33道_p3_1_8ea9bb9c.png)
...
throw关键字作用是在方法内部抛出一个Throwable 类型的异常。任何Java代码都可以通过throw
语句抛出异常。
3. 捕获异常
...
![Java异常面试题 33道 第4页插图](../assets/images/Java异常面试题_33道_p4_1_0a5282f8.png)
...
常，编译器要求必须用catch捕获以便进一步处理；如果运行时异常，捕获然后丢弃并且+ﬁnally扫
...
非稳定代码的catch尽可能进行区分异常类型，再做对应的异常处理。 说明：对大段代码进行try-
catch，使程序无法根据不同的异常做出正确的应激反应，也不利于定位问题，这是一种不负责任
