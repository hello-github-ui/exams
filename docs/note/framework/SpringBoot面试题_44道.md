---
title: SpringBoot面试题 44道
source: Note/SpringBoot面试题 44道.pdf
pages: 9
...
![SpringBoot面试题 44道 第1页插图](../assets/images/SpringBoot面试题_44道_p1_1_0b055075.png)
...
@ImportResource： 相当于xml的 < import resource="applicationContext-
cache.xml">
 
...
我们都知道，新创建一个 Spring Boot 项目，默认都是有 parent 的，这个 parent 就是 spring-
boot-starter-parent ，spring-boot-starter-parent 主要有如下作用：
